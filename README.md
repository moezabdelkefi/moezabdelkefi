...
| Qrcode             | create a Qrcode based on the user link           | [Link to Project 3]([/python_projects/blob/main/Qrcode.py](https://github.com/moezabdelkefi/python_projects/blob/main/Qrcode.py))) |
