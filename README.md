...
<table>
  ...
  <tr>
    <td>Madlibs</td>
    <td>Add code for reading a story and replacing words</td>
    <td><a href="https://github.com/moezabdelkefi/python_projects/blob/main/Madlibs.py">Link to Project 1</a></td>
  </tr>
  <tr>
    <td>Pig</td>
    <td>Implement a simple dice game in Python</td>
    <td><a href="https://github.com/moezabdelkefi/python_projects/blob/main/Pig.py">Link to Project 2</a></td>
  </tr>
  <tr>
    <td>Qrcode</td>
    <td>Create a QR code based on the user link</td>
    <td><a href="https://github.com/moezabdelkefi/python_projects/blob/main/Qrcode.py">Link to Project 3</a></td>
  </tr>
  <tr>
    <td>Timed_Math_Challenge</td>
    <td>Add a Python math quiz game</td>
    <td><a href="https://github.com/moezabdelkefi/python_projects/blob/main/Timed_Math_Challenge.py">Link to Project 4</a></td>
  </tr>
  <tr>
    <td>anime_recommendation</td>
    <td>Anime recommendation based on user mood</td>
    <td><a href="https://github.com/moezabdelkefi/python_projects/blob/main/anime_recommendation.py">Link to Project 5</a></td>
  </tr>
  <tr>
    <td>clock</td>
    <td>Add time script for displaying current time</td>
    <td><a href="https://github.com/moezabdelkefi/python_projects/blob/main/clock.py">Link to Project 6</a></td>
  </tr>
</table>
</p>
